...
const permissionConfig = () => {
  ...
  let rolesNames = ['tools', 'editor', 'clipboard', 'permission', 'sticky', 'uploadAvatar', 'nested', 'menu1', 'menu1-1', 'menu1-2', 'menu1-1-info', 'ocr', 'languages'] //权限名称
